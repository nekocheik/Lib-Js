...
},{"./TweenLite.js":"../node_modules/gsap/TweenLite.js"}],"js/main.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.scrollControlled = void 0;
...
for (var i = 0; i < 100; i++) {
  ...
  div.style.backgroundColor = "".concat(colorSet());
  body.append(div);
} //typical import


var scrollControlled =
/*#__PURE__*/
function () {
  function scrollControlled(scrollSpeed, page) {
    var sensibility = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1.5;

    _classCallCheck(this, scrollControlled);
  ...
  _createClass(scrollControlled, [{
    ...
    value: function view() {
      ...
      //   this.resize();
      //  };
      window.fullscreenchange = function (e) {
        _this.resize();
      };
    ...
    value: function render() {
      _TweenMax.TweenMax.to(window, this.scrollSpeed, {
        scrollTo: this.newPosition,
        ease: Power3.easeOut
      });
    } // resize(){
...
exports.scrollControlled = scrollControlled;
new scrollControlled(1.2, document.querySelector('body'), 9);
},{"gsap/TweenMax":"../node_modules/gsap/TweenMax.js","gsap/ScrollToPlugin":"../node_modules/gsap/ScrollToPlugin.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
